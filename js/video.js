$(function() {
    ...
    $play
        .on('click', function() {
            if (player.paused) {
                player.play();
                $(this).removeClass('icon-bofang').addClass('icon-bofangzanting');
            } else {
                player.pause();
                $(this).removeClass('icon-bofangzanting').addClass('icon-bofang');
            }
        });
    ...
    $expand
        .on('click', function() {
            if (!document.webkitIsFullScreen) {
                ...
                $(this).removeClass('icon-quanping').addClass('icon-xiaoping');
            } else {
                player.webkitCancelFullScreen();
                $(this).removeClass('icon-xiaoping').addClass('icon-quanping');
